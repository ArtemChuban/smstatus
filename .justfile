...
build-modules: build-battery build-datetime build-keyboard
...
test-modules: test-battery test-datetime test-keyboard
...
clippy:
    cargo clippy -p battery -p datetime -p keyboard --target {{wasm-target}} -- -D warnings
